# Generated by Powerlevel10k configuration wizard on 2020-07-20 at 18:14 CDT.
...
() {
  ...
  # Custom prefix.
  typeset -g POWERLEVEL9K_VCS_PREFIX='%fen '
  ...
  # Custom prefix.
  #typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_PREFIX='%fDuración '
